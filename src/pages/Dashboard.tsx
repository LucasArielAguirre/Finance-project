...
useEffect(() => {
  ...
  return (
    ...
    <div className="col-span-2 row-span-3 col-start-3 border border-white/80 bg-white/20 bg-clip-padding backdrop-filter  backdrop-blur-2xl backdrop-saturate-100 backdrop-contrast-100 ">2</div>
    <div className="col-span-2 row-span-3 col-start-5 border border-white/80 w-full text-white justify-center align-middle flex flex-col items-center bg-white/20 bg-clip-padding backdrop-filter  backdrop-blur-2xl backdrop-saturate-100 backdrop-contrast-100">
        {dolarBlue ? (
    ...
    <div className="row-span-3 row-start-4 border border-white/80 bg-white/20 bg-clip-padding backdrop-filter  backdrop-blur-2xl backdrop-saturate-100 backdrop-contrast-100">4</div>
    <div className="row-span-3 row-start-4 border border-white/80 bg-white/20 bg-clip-padding backdrop-filter  backdrop-blur-2xl backdrop-saturate-100 backdrop-contrast-100">5</div>
    <div className="col-span-4 row-span-3 row-start-4 border border-white/80 bg-white/20 bg-clip-padding backdrop-filter  backdrop-blur-2xl backdrop-saturate-100 backdrop-contrast-100">6</div>
    <div className="col-span-6 row-span-3 row-start-7 border border-white/80 bg-white/20 bg-clip-padding backdrop-filter  backdrop-blur-2xl backdrop-saturate-100 backdrop-contrast-100">
